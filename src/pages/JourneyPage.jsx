...
export default function JourneyPage() {
  const regionNames = useMemo(() => Object.keys(mapData), [])
    ...
    <>
      <section className="mb-5">
        ...
        <p className="page-copy">
          Start by choosing a country or region. Each section opens the places and stories that have shaped my journey.
        </p>
      </section>

      <RegionSelector mapData={mapData} activeRegion={activeRegion} onSelectRegion={setActiveRegion} />
